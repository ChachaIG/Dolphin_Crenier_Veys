...
public class ResTotKMActivity extends AppCompatActivity {
    ...
    private TextView resTotKm2;
    private TextView resTotKm4;
    ...
    public void init() {
        ...
        resTotKm2 = (TextView)findViewById(R.id.resTotKm2);
        resTotKm4 = (TextView)findViewById(R.id.resTotKm4);
        switch (switchSelect){
            case 1: resTotKm2.setText(""+dateDeb.get(Calendar.YEAR));
                break;
            case 2: resTotKm2.setText(ac.getNomDuMois(dateDeb)+" "+dateDeb.get(Calendar.YEAR));
                break;
            case 3: resTotKm2.setText(getString(R.string.saison)+" "+dateDeb.get(Calendar.YEAR)+"/"+dateFin.get(Calendar.YEAR));
                break;
        }
        getMatchUtilisateur();
    }
        ...
        JsonArrayRequest getMatchUtil = new JsonArrayRequest(Request.Method.GET, "http://dolphinapp.azurewebsites.net/api/match?idUUtilisateur=" + util.getIdUtilisateur(), new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                try {
                    ...
                    resTotKm4.setText(""+distanceStr.substring(0,5)+" KM");
